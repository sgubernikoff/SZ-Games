  ...
  return (
    <div className="login-form">
      <form onSubmit={handleAccountSubmit}>
        ...
        <input type="password" placeholder="Enter Confirmation" name="passwordConfirmation" 
        required onChange={handleAccountChange} value={accountInfo.passwordConfirmation}></input><br></br>
